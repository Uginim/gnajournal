...
그래서 세션 후반의 요청이 초반보다 훨씬 비쌉니다. 참고로 컨텍스트 윈도우 크기는 모델과 플랜에 따라 다릅니다. 유료 플랜에서 최신 모델은 최대 1M을 지원하고 나머지는 500K나 200K입니다. 윈도우의 일부는 항상 응답용으로 예약되므로, 실제로 담을 수 있는 대화는 윈도우 전체보다 조금 작습니다.
